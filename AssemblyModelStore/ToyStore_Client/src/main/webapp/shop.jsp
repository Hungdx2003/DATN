				        ...
				        <div class="col-lg-12 text-center">
						    <div class="pagination__option">
								<c:if test="${currentPage > 1}">
						            <a href="?view=shop&page=${currentPage - 1}"><i class="fa fa-angle-left"></i></a>
						        </c:if>
						        <c:forEach var="page" items="${paginationData}">
						            <c:choose>
						                ...
						                <c:when test="${page == currentPage}">
						                    <a class="active" href="?view=shop&page=${page}">${page}</a>
						                </c:when>
						
						                <c:otherwise>
						                    <a href="?view=shop&page=${page}">${page}</a>
						                </c:otherwise>
						            </c:choose>
						        </c:forEach>
						
						        <c:if test="${currentPage < totalPages}">
						            <a href="?view=shop&page=${currentPage + 1}">
