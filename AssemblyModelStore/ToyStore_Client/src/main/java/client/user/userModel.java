...
public class userModel {
	...
	public boolean isUsernameExists(String username) {
		return this.u.isUsernameExists(username);
	}

	public boolean isEmailExists(String email) {
		return this.u.isEmailExists(email);
	}
	...
	public UserObject getUserObject(String email, String userpass) {
		UserObject item = null;

		ResultSet rs = this.u.getUser(email, userpass);
		if (rs != null) {
			try {
				if (rs.next()) {
					item = new UserObject();
	...
	public ArrayList<UserObject> getUserObjects(UserObject similar, int at, byte total) {
	    ...
	    ArrayList<ResultSet> res = this.u.getUser(similar, at, total);
